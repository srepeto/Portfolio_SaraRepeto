...
public class Asignacion {
    ...
    public void asigCombos(ComboBox alumnoCombo, ComboBox empresaCombo, ComboBox tutorCombo) {
        ...
        try {
            ...
            while (resulAlum.next()) {
                ...
                alumnoCombo.getItems().add(ape + ", " + nom);
            }
            ...
            while (resulEmp.next()) {
                ...
                empresaCombo.getItems().add(nomEmp);
            }
            ...
            while (resulTut.next()) {
                ...
                tutorCombo.getItems().add(nomTut);
            }
